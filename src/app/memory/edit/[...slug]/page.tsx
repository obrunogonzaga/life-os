  ...
  return (
    <div className="max-w-3xl mx-auto py-10 px-8">
      <header className="mb-8">
        ...
        <h1 className="text-3xl font-bold text-neutral-900 dark:text-white">Edit Document</h1>
        <p className="text-neutral-500 dark:text-neutral-400 mt-2">{slug}.md</p>
      </header>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-lg text-neutral-900 dark:text-white focus:outline-none focus:border-neutral-400 dark:focus:border-neutral-700"
            required
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            rows={20}
            className="w-full px-4 py-3 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-lg text-neutral-900 dark:text-white focus:outline-none focus:border-neutral-400 dark:focus:border-neutral-700 font-mono text-sm"
            required
          />
        </div>
